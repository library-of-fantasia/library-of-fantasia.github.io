...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1125: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_4048: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_4048_2: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_4048_3: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_3687: (a: number, b: number) => void;
