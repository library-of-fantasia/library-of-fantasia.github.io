...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_4721: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_8177: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_6414: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_6414_20: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_6414_21: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2984: (a: number, b: number) => void;
