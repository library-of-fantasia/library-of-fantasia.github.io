...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_3487: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2929: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2929_20: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2929_21: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2909: (a: number, b: number) => void;
