...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_3434: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_3496: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2938: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2938_20: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_2938_21: (a: number, b: number, c: number) => void;
